        ...
        <div className="p-6 space-y-6 text-xs">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="block text-[10px] font-black uppercase text-gray-500">Customer Code (Optional)</label>
                <input
                  type="text"
                  value={formCode}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="block text-[10px] font-black uppercase text-gray-500">Initial Account Balance ($)</label>
                <input
                  type="number"
                  value={formBalance}
          ...
          <div className="bg-white pt-4 flex flex-wrap gap-2 justify-end shrink-0">
            <button
              type="button"
              onClick={onClose}
            ...
            <button
              ...
              className="rounded-lg border border-gray-200 bg-slate-100 hover:bg-slate-200 px-4 py-2 text-xs font-bold text-slate-800 shadow-xs transition"
            >
              Save & Add Another
            </button>
            <button
