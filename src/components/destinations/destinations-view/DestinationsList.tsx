...
import { Destination, Customer } from "../../../types";
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-1 max-w-4xl">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-1.5 bg-slate-50 border-0 focus:bg-white rounded-lg text-xs font-medium text-gray-800 transition focus:outline-hidden focus:ring-2 focus:ring-blue-500/20"
            />
            {localSearchQuery && (
              <button
