...
import { Carrier, Driver } from "../../../../types";
...
export default function CarterInfoTab({ driver, linkedCarter }: CarterInfoTabProps) {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-xs max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-400 font-bold">Carter ID:</span>
                  <span className="font-black font-mono text-gray-900 bg-slate-100 px-2 py-0.5 rounded">
                    {linkedCarter.id}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400 font-bold">Carter Name:</span>
                  <span className="font-extrabold text-gray-900">{linkedCarter.name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400 font-bold">Operational Status:</span>
                  <span
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-400 font-bold">Default Transport Rate:</span>
                ...
                {linkedCarter.email && (
                  <div className="flex justify-between">
                    <span className="text-gray-400 font-bold">Dispatch Email:</span>
          ...
          <div className="bg-slate-50 border border-slate-150 rounded-lg p-5 flex items-start gap-3 text-xs text-gray-500">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-500 leading-relaxed">
                The carter labeled <strong>"{driver.carrierName}"</strong> is currently listed as an
