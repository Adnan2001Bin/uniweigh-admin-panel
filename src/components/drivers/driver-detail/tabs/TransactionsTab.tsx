...
import { Driver, Transaction, TransactionStatus } from "../../../../types";
            ...
            {linkedTransactions.length === 0 ? (
              ...
              linkedTransactions.map((t) => (
                <tr key={t.id} className="hover:bg-slate-50/50 transition duration-150">
                  ...
                  <td className="px-5 py-3.5 font-bold font-mono text-slate-700">{t.vehicleReg}</td>
                  ...
                  <td className="px-5 py-3.5 text-center">
                    <button
                      ...
                      className="rounded-md border border-gray-200 bg-white hover:bg-slate-50 text-gray-700 p-1 px-2.5 text-[10px] font-black transition flex items-center gap-1 cursor-pointer select-none"
