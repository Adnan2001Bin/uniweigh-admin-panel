...
export function getDefaultDocketConfig(): DocketConfig {
  return {
...
export function generateInvoiceHtml(
  ...
  const logoHtml = config.showLogo
    ? config.logoUrl
      ? `<img src="${config.logoUrl}" style="max-height: 55px; max-width: 100px; object-fit: contain;" />`
      : `
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .header-table { width: 100%; border-collapse: collapse; border-bottom: 2px solid #e2e8f0; margin-bottom: 15px; }
          .logo-cell { width: 65px; vertical-align: top; padding-bottom: 15px; }
          .brand-cell { vertical-align: top; padding-left: 15px; padding-bottom: 15px; }
          .brand-name { font-size: 15px; font-weight: 900; color: #0f172a; text-transform: uppercase; letter-spacing: -0.5px; margin: 0; }
          .brand-subtitle { font-size: 8px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 2px; }
          .contact-cell { text-align: right; vertical-align: top; font-size: 9px; color: #475569; line-height: 1.4; padding-bottom: 15px; }
          .contact-name { font-weight: 800; color: #0f172a; font-size: 10px; }
          .docket-title-container { text-align: center; margin: 15px 0; border-top: 2px solid #0f172a; border-bottom: 2px solid #0f172a; padding: 6px 0; position: relative; }
          .docket-title { font-size: 14px; font-weight: 900; letter-spacing: 2px; text-transform: uppercase; color: #0f172a; margin: 0; }
          .reprint-badge { display: inline-block; background: #0f172a; color: #fff; font-size: 8px; font-weight: 900; padding: 2px 10px; border-radius: 4px; text-transform: uppercase; letter-spacing: 1px; margin-top: 4px; }
          .details-table { width: 100%; border-collapse: collapse; margin-bottom: 15px; }
          .details-table td { padding: 6px 8px; font-size: 11px; border-bottom: 1px solid #f1f5f9; vertical-align: top; }
          .label-col { font-weight: 700; color: #64748b; text-transform: uppercase; font-size: 9px; width: 25%; }
          .val-col { font-weight: 800; color: #0f172a; width: 25%; }
          .pricing-section { margin-top: 15px; border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px; background-color: #f8fafc; }
          .pricing-table { width: 100%; border-collapse: collapse; }
          .pricing-table td { padding: 4px 0; font-size: 11px; }
          .pricing-total { border-top: 2px solid #cbd5e1; font-weight: bold; }
          .pricing-total td { padding-top: 8px; font-size: 12px; }
          .eft-box { border: 1px solid #cbd5e1; border-radius: 6px; padding: 10px; background: #f8fafc; margin-top: 15px; font-size: 9px; }
          .eft-title { font-weight: 900; color: #475569; font-size: 8px; margin-bottom: 3px; letter-spacing: 0.5px; }
          .barcode-box { text-align: center; font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 5px; color: #94a3b8; margin: 15px 0; }
          .footer-section { font-size: 9px; color: #64748b; text-align: center; border-top: 1px solid #e2e8f0; padding-top: 12px; }
          .signatures-table { width: 100%; margin-top: 35px; margin-bottom: 15px; }
          .signatures-table td { width: 50%; vertical-align: bottom; font-size: 9px; color: #475569; text-align: center; }
          .signature-line { width: 75%; margin: 0 auto 4px auto; border-top: 1px solid #475569; }
          @media print {
            body { background: none; }
            .page { width: 21cm; height: 29.7cm; padding: 1.5cm; margin: 0; box-shadow: none; page-break-after: always; }
          }
        </style>
      </head>
      <body>
...
export function generateDocketHtml(transaction: Transaction, config: DocketConfig, reprintCopy: boolean): string {
  return `
    <html>
      <head>
        ...
        <style>
          ...
          .label-col { font-weight: 700; color: #64748b; text-transform: uppercase; font-size: 9px; width: 25%; }
          .val-col { font-weight: 800; color: #0f172a; width: 25%; }
          .weights-box { border: 1px solid #cbd5e1; border-radius: 8px; background-color: #f8fafc; padding: 12px; margin: 15px 0; }
          .weights-table { width: 100%; border-collapse: collapse; }
          .weights-table th { text-align: center; font-size: 9px; font-weight: 800; color: #475569; text-transform: uppercase; padding-bottom: 6px; border-bottom: 2px solid #cbd5e1; }
          .weights-table td { text-align: center; font-family: 'JetBrains Mono', monospace; font-size: 13px; font-weight: 800; color: #0f172a; padding-top: 8px; }
          .weights-table .net-row td { font-size: 16px; font-weight: 900; color: #2563eb; }
          .comments-box { border: 1px solid #e2e8f0; background: #f8fafc; border-radius: 6px; padding: 8px 12px; font-size: 9px; color: #475569; margin-bottom: 15px; }
          .comments-title { font-weight: 800; color: #0f172a; text-transform: uppercase; margin-bottom: 3px; }
          .pricing-section { border-top: 1.5px dashed #cbd5e1; padding-top: 12px; margin-top: 12px; }
          .pricing-table { width: 100%; border-collapse: collapse; }
          .pricing-table td { font-size: 11px; padding: 5px 0; }
          .pricing-total { font-size: 13px; font-weight: 900; color: #0f172a; border-top: 2px solid #0f172a; padding-top: 6px; }
          .eft-box { border: 1px solid #cbd5e1; background-color: #f8fafc; border-radius: 6px; padding: 10px; font-size: 9px; color: #475569; margin-bottom: 15px; }
          .eft-title { font-weight: 800; color: #0f172a; text-transform: uppercase; font-size: 8px; margin-bottom: 3px; letter-spacing: 0.5px; }
          .barcode-box { text-align: center; font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 5px; color: #94a3b8; margin: 15px 0; }
          .footer-section { font-size: 9px; color: #64748b; text-align: center; border-top: 1px solid #e2e8f0; padding-top: 12px; }
          .signatures-table { width: 100%; margin-top: 35px; margin-bottom: 15px; }
          .signatures-table td { width: 50%; vertical-align: bottom; font-size: 9px; color: #475569; text-align: center; }
        ...
        <div class="page">
          <div>
            ...
            <div class="comments-box">
              ...
              <p style="margin: 0;">Own Driver. Wear appropriate high-vis PPE, safety glasses, and steel caps at all times. Follow strict 20 km/h quarry limits. Weighbridge certified under scale ID ${transaction.scaleIdInbound}.</p>
            </div>
